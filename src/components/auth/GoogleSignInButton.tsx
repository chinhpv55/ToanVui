  ...
  return (
    <div className="space-y-2">
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="w-full py-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold text-lg rounded-xl transition-colors touch-target disabled:opacity-50 flex items-center justify-center gap-3"
      >
